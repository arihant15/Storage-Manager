...
6) To remove object files, run following command:
   make clean
7) We have provided additional testcases in file "test_assign1_2.c 
...
1) RC_FILE_PRESENT 5- Returned if file exists
2) RC_FILE_READ_ERROR 6- Returned if the block is not read completely.
3) RC_WRITE_OUT_OF_BOUND_INDEX 7- Returned if file descriptor points beyond file page limits
